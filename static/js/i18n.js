...
const translations = {
  en: {
    ...
    'add.customer_name_placeholder': 'Enter customer name',
    'add.customer_phone': 'Customer Phone',
    'add.customer_phone_placeholder': 'Enter phone number',
  ...
  fa: {
    ...
    'add.customer_name_placeholder': 'نام مشتری را وارد کنید',
    'add.customer_phone': 'شماره تماس مشتری',
    'add.customer_phone_placeholder': 'شماره تلفن را وارد کنید',
    ...
    'login.username_placeholder': 'نام کاربری را وارد کنید',
    'login.password': 'رمز عبور',
    'login.password_placeholder': 'رمز عبور را وارد کنید',
    'login.sign_in': 'ورود',
    'nav.logout': 'خروج',
  }
};
